...
def _batch(self, chunk):
    ...
    celly = 1.0 * h / S
    for obj in allobj:
        centerx = 0.5 * (obj[1] + obj[3])  # xmin, xmax
        centery = 0.5 * (obj[2] + obj[4])  # ymin, ymax
        cx = centerx / cellx
        cy = centery / celly
        if cx >= S or cy >= S:
            return None, None
    ...
    for obj in allobj:
        ...
        prear[obj[5], 0] = obj[1] - obj[3] ** 2 * 0.5 * S  # xleft
        prear[obj[5], 1] = obj[2] - obj[4] ** 2 * 0.5 * S  # yup
        prear[obj[5], 2] = obj[1] + obj[3] ** 2 * 0.5 * S  # xright
        prear[obj[5], 3] = obj[2] + obj[4] ** 2 * 0.5 * S  # ybot
        confs[obj[5], :] = [1.0] * B
